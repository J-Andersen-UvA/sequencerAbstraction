...
| **Sequencer**  | `GetAllTracksInCurrentSequence()`                                                                                                                                                                        | Returns all master and object-bound tracks in the currently opened sequence as `FSequenceTrackInfo`.                                |
...
| **Timing**     | `SetSequenceFrameRateFromAnimation(ULevelSequence* Sequence, UAnimSequence* Animation, bool bAlsoSetPlaybackRangeToAnim, FSequenceOpenResult& Result)`                                                   | Sets the sequence display rate from the animation’s sampling rate. Optionally updates playback range to match the animation length. |
| **Timing**     | `SetSequencePlaybackRange(ULevelSequence* Sequence, int32 StartFrame, int32 EndFrame)`                                                                                                                   | Sets the playback range of the sequence in frames.                                                                                  |
| **Timing**     | `GetSequencePlaybackRange(ULevelSequence* Sequence, int32& OutStartFrame, int32& OutEndFrame)`                                                                                                           | Retrieves the current playback range in frames.                                                                                     |
| **Timing**     | `MoveAnimationSectionStartTo(UMovieSceneSkeletalAnimationSection* Section, int32 NewStartFrame)`                                                                                                         | Moves an animation section start frame to the specified frame.                                                                      |
| **Timing**     | `MoveAnimationSectionEndTo(UMovieSceneSkeletalAnimationSection* Section, int32 NewEndFrame)`                                                                                                             | Moves an animation section end frame to the specified frame.                                                                        |
| **Animation**  | `AddAnimationToBinding(ULevelSequence* Sequence, const FGuid& BindingGuid, UAnimSequence* Animation, int32 StartFrame, FSequenceOpenResult& Result)`                                                     | Adds a skeletal animation track to an existing binding and inserts an animation section at the specified start frame.               |
